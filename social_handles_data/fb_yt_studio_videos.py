...
def get_youtube_video_ids():
    ...
    print "yt video ids n: " + str(len(youtube_video_ids))
...
def get_facebook_video_ids():
    ...
    print "fb video ids n: " + str(len(facebook_video_ids))
...
def fetch_data():
    ...
    while i < len(video_ids):
        ...
        i = i + 1
    print sum(facebook_grand_likes)
    print sum(youtube_grand_likes)
    print sum(facebook_grand_views)
    print sum(youtube_grand_views)
    print sum(facebook_grand_comments)
    print sum(youtube_grand_comments)
