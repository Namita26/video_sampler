...
def glamrs_youtube_views(video_id):
    ...
    video = vmap[video_id]
    res = requests.get("https://www.googleapis.com/analytics/v3/data/ga?ids=ga%3A67237418&start-date=2015-01-01&end-date=today&metrics=ga%3Apageviews&dimensions=ga%3ApagePath&filters=ga%3ApagePath%3D%40" + video, headers={"Authorization": "Bearer ya29.rgLNcBciM3vi56WkuaKfNmYyi-GlIFXUlYsec2ENUAVr7RGqdxWRw24-IAEiMIQZ4g"})
